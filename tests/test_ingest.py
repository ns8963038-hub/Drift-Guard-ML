...
from monitoring.services import (
    IngestionError,
    compute_baseline_prediction_distribution,
    ingest_batch,
)
...
@pytest.fixture
def churn_model(tmp_path, settings):
    """A fully set-up model: baseline uploaded, version uploaded and activated."""
...
def drifted(n=600, seed=1):
    """A batch with a shifted numeric column and a flipped category mix."""
